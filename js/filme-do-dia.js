...
const pegarDados = async () => {
    const respostaGeral = await (await fetch('https://tmdb-proxy.cubos-academy.workers.dev/3/movie/436969?language=pt-BR')).json()
    const respostaVideo = await (await fetch('https://tmdb-proxy.cubos-academy.workers.dev/3/movie/436969/videos?language=pt-BR')).json()

    titulo.textContent = respostaGeral.title
    average.textContent = respostaGeral.vote_average
